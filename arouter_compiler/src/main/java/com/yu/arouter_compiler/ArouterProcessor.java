package com.yu.arouter_compiler;
...
import com.yu.arouter_compiler.utils.EmptyUtils;
...
// 需要处理的注解
@SupportedAnnotationTypes({"com.yu.arouter_annotation.ARouter"})
// 指定JDK编译版本
...
public class ArouterProcessor extends AbstractProcessor {
    ...
    private void parseElements(Set<? extends Element> elements) throws IOException {
        ...
        // 最终生成的类文件名
        String finalClassName = "ARouter$$Path$$" + moduleName;
